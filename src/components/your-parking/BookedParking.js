...
import { faMapMarkerAlt, faClock, faCheckCircle, faPen} from '@fortawesome/free-solid-svg-icons'
...
const BookedParking = ({ item, setSelectedParking, bookingConfirmed, setBookingConfirmed }) => {
      ...
      <h3 className='booked-search__heading heading-secondary padding-tb-2'>
        ...
        {(item && bookingConfirmed) ?(
          <div>
            ...
            >
              <div className='search__location-item-content row'>
                <div className='search__location-item-left'>
                  ...
                  <p className='search__location-item-location margin-bottom-2'>{item.zipCode}</p>
            ...
            <Link className='button-primary margin-0-auto'>Open parking space</Link>
              ...
              <div className='booked__button-container margin-top-2'>
                <div className='booked__button'>
                  ...
                  <div className='booked__button-right'>
                    <p className='boMapMarkerAltoked__button-text-sm'>Download on the</p>
            ...
            {success === '' ? (
              ...
              >
                <div className='confirmation-container-wrap'>
                  ...
                  <p className='confirmation-container-wrap-text'>You succesfully booked a parking space</p>
                </div>
            </div>
            ) : ('')}
